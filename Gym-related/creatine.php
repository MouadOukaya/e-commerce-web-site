...
<body>
  ...
  <main class="product-grid-container">
    <?php 
    $getposts = mysqli_query($conn, "SELECT * FROM products WHERE available >= '1' AND item ='saree' ORDER BY id DESC LIMIT 10");
    if (mysqli_num_rows($getposts) > 0) {
        ...
        echo '
          <div class="product-card">
            <a href="view_product.php?pid='.$id.'">
              <img src="../image/product/saree/'.$picture.'" class="home-prodlist-imgi" alt="'.$pName.'">
            </a>
      ...
      echo '<p style="text-align:center; font-size:18px;">No sarees available right now.</p>';
    }
    ?>
  </main>
